...
##### Q. 中身スカスカやんけ！
{{% alert icon="" context="light" %}}
公開当初よりも大幅にコンテンツを拡充しています。2024年の公開以降、プロンプト集は15カテゴリに広がり、リテラシーから応用まで段階的に学べる構成になりました。[活用事例]({{% relref "/docs/cases" %}})も充実してきています。引き続き更新を続けていきますので、ぜひご活用ください。
{{% /alert %}}
...
##### Q. 生成AIの料金が気になる
{{% alert icon="" context="light" %}}
多くの生成AIサービスには無料プランが用意されており、まずは無料版で十分に試すことができます。有料プランの料金体系はサービスごとに異なり、変更されることもありますので、各サービスの公式サイトで最新情報をご確認ください。
P4Usの[リンク集]({{% relref "/docs/links" %}})に主要な生成AIサービスをまとめています。
{{% /alert %}}
