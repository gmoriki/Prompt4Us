---
weight: 999
title: "ChatGPTハンズオン@オンライン"
description: "大学職員のためのChatGPTハンズオンの会"
icon: "article"
...
- 多くの企業がExcelを使ってプロジェクトの日程管理をしている。
- Excelはオフィスで重要なアプリケーションであり、多くの人に利用されている。
- 複数のプロジェクトが同時に進行すると、変更の際に整合性の問題が生じることがある。
- 日立ソリューションズ東日本の『SynViz S2』は、プロジェクト管理に特化したツールであり、Excelの使いやすさを備えつつ、リアルタイムでの変更反映や日程間の連携機能を提供している。
- SynViz S2の採用により、企業はプロジェクト管理の効率化が図られ、海外生産拠点への展開も検討されている。
{{% /alert %}}
...
あまりよくない例： ※ 検索エンジン型のCopilotやGeminiであれば問題ありません
```
鎌倉幕府　いつから
```
{{% alert icon="🤖" context="success" %}}
...
- AIをあなたのサポーターにする  
文章を扱う仕事や、アイデアを文章に落としてみたら、ChatGPTに入力することを検討しよう

- 今はまだ試行錯誤の時期です  
最新情報は「いろいろ人に訊く」前に「自分で使ってみてから考える」方が良い  
専門家/ヘビーユーザーでも知らない・分からないことも多い  
    例：ChatGPTとCopilotとGeminiの性能比較！！！まず使ってください！！！！！！！！

- 今日のハンズオンどうでした？  
　　Webページが見づらい・内容が簡単すぎる/難しすぎるなど、もしよければ教えてください🙇‍♂️