...
AIエージェントの技術的な仕組みについては[生成AIとツールの連携]({{% relref "/docs/essence/external-tools" %}})をご覧ください。
...
[プロンプトの現在地]({{% relref "/docs/essence/prompt-landscape" %}})で述べたように、AIの活用は「一問一答」から「タスクの委任」へと広がっています。
...
これは[AIとの付き合い方]({{% relref "/docs/essence/ai-partnership" %}})で紹介した「壁打ち相棒」の考え方を、さらに一歩進めたものです。
...
詳しくは[生成AIの限界と課題]({{% relref "/docs/essence/risk-management" %}})もあわせてご確認ください。
...
エージェント型のAI活用は、[AIとの付き合い方]({{% relref "/docs/essence/ai-partnership" %}})で紹介した「壁打ち相棒」の究極の形ともいえます。
