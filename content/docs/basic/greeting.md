...
早速、生成AIを使ってみましょう。
Web検索機能が無いシンプルなChatGPTを使用しています。
...
|----------|--------------|---------|
| 2024/1/20 | ChatGPT |https://chatgpt.com/share/3c0de797-52f1-4cf7-8f15-9ffda21944aa|
{{< /table >}}
...
例えば生成AIサービスによっては、学習データの知識カットオフ日以降の情報を参照できない場合があります。
