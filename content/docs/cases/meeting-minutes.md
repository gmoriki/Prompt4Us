...
{{< alert context="info" text="**想定シーン**: 会議のメモや走り書きをもとに、正式な議事録のドラフトを作成する" />}}
...
{{< alert context="info" text="**想定シーン**: 会議前に配布資料を読み込み、論点を整理して参加者に共有する" />}}
...
{{< alert context="info" text="**想定シーン**: 会議終了後に、議事メモからアクションアイテム（誰が・何を・いつまでに）を抽出する" />}}
...
{{< alert context="info" text="**想定シーン**: 次回の委員会や定例会議に向けて、議題の整理と時間配分を含むアジェンダ（会議次第）を作成する" />}}
...
{{< alert context="info" text="**想定シーン**: 会議終了後、出席者や関係者に対して決定事項とアクションアイテムを共有するメールを作成する" />}}
...
{{< alert context="info" text="**想定シーン**: 会議の議題一覧を整理し、審議事項（議論・決定が必要なもの）と報告事項（共有のみ）を区分する" />}}
